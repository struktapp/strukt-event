...
class EventTest extends PHPUnit\Framework\TestCase{
	...
	public function setUp():void{
		...
		$this->login = Event::create(function($username, $password) use ($credentials){
	...
	public function testApplyInput(){
		...
		$this->assertTrue($this->login->apply($username, $password)->exec());
	}
	...
	public function testApplyArgsSequentialInput(){
		...
		$this->assertTrue($this->login->applyArgs($credentials)->exec());
	}
